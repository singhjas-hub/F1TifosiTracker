    ...
    return (
        <nav className="f1-nav">
            ...
            <div className="nav-links">
                ...
                {/* Profile Link: Provides access to user settings and historical audit data */}
                <span onClick={() => setView('profile')} style={{ marginRight: '15px' }}>
                    Profile
                </span> 

                {/* Logout Action: Triggers clear-session logic and localStorage removal */}
